...
class Settings(BaseSettings):
    ...
    # Composio
    composio_api_key: Optional[str] = Field(default=None, description="Composio API key")
    ...
    # Obsidian
    obsidian_api_url: Optional[str] = Field(default=None, description="Obsidian API URL")
    obsidian_api_key: Optional[str] = Field(default=None, description="Obsidian API key")
    ...
    jupyter_token: Optional[str] = Field(default=None, description="Jupyter token")
