...
class DatabaseManager:
    ...
    def get_model_context(self, model_id: str) -> Optional[ModelContextDB]:
    ...
    def get_model_context_dict(self, model_id: str) -> Optional[Dict[str, Any]]:
