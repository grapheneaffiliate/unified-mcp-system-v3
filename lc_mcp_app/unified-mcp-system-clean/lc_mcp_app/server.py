...
from .middleware.rate_limit import rate_limit, periodic_cleanup
from .middleware.metrics import record_metrics, metrics_endpoint
from .clients.mcp_client import get_mcp_client, close_mcp_client
from .tools.registry import initialize_tools, get_registry
...
def register_routes(app: FastAPI):
    ...
    async def chat_completions(request: ChatCompletionRequest, raw_request: Request):
        ...
        try:
            ...
            # Extract user input and chat history
            user_input = extract_user_message(request.messages)
