...
class Settings(BaseSettings):
    ...
    mcp_username: Optional[str] = Field(default=None, description="MCP server username")
    mcp_password: Optional[str] = Field(default=None, description="MCP server password")
